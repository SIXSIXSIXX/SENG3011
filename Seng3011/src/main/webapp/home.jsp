...
<body>
    <div class="panel-align inner-middle"><img src="/Seng3011/resources/img/banner.png"></div>
    
    <div class="panel-body middle-align nopad">
        <div class="panel panel-default">
            <div class="panel-heading bold size2">Events / Updates</div>
            <table class="table secondright">
                <tr>
                	<td><a href="documentation.jsp">Version 1.0 Released!!!</a></td>
                    <td>30/03/17</td>
                </tr>
                <tr>
                	<td><a href="documentation.jsp">Version 2.0 Released!!!</a></td>
                    <td>13/04/17</td>
                </tr>
            </table>
        </div>
